let LanguageHandler = {
  ...
  translateUI: function () {
    ...
    for (let i = 0; i < elements.length; i++) {
      ...
      let englishtext = element.getAttribute("data-english-text");
  ...
  translations: {
    ...
    "ar": {
      ...
      "Undo": "تراجع",
      "Redo": "إعادة",
    "Split Screen": "شاشة مقسمة",
    "Unsplit Screen": "إلغاء تقسيم الشاشة",
    },
    "bn": {
      "rtl": false,
      "About": "সম্পর্কে",
      ...
      "Bold":  "বোল্ড",
      "Italic": "ইটালিক",
      "Block Quote":    "ব্লক উদ্ধৃতি",
      "Cut":  "কাট",
      "Copy":   "কপি",
      "Paste":  "পেস্ট",
      "Undo": "পূর্ববর্তী",
      "Redo": "পুনরায় করুন",
      "Split Screen": "ভাগ স্ক্রিন",
      "Unsplit Screen": "অভাগিত স্ক্রিন",
    },
    "de": {
      "rtl": false,
      "About": "Über",
      ...
      "Undo":  "Rückgängig",
      "Redo":   "Wiederholen",
      "Split Screen": "Bildschirm teilen",
      "Unsplit Screen": "Bildschirm nicht teilen",
    ...
    "es": {
      ...
      "Print Slides": "Imprimir diapositivas",
      ...
      "Unsplit Screen": "Pantalla no dividida",
    ...
    "fa": {
      ...
      "Undo":  "بازگشت",
      "Redo":   "انجام مجدد",
      "Split Screen": "تقسیم صفحه",
      "Unsplit Screen": "تقسیم صفحه نشده",
    },
    "fr": {
      "rtl": false,
      "About": "À propos",
      ...
      "Print Slides": "Imprimer les diapositives",
      ...
      "Unsplit Screen": "Écran non divisé",
    ...
    "hi": {
      ...
      "Print Slides": "स्लाइड्स प्रिंट करें",
      ...
      "Undo":  "पूर्ववत करें",
      "Redo":   "फिर से करें",
      "Split Screen": "स्प्लिट स्क्रीन",
      "Unsplit Screen": "स्क्रीन अस्प्लिट",
    },
    "ja": {
      "rtl": false,
      "About": "約",
    ...
    "pt": {
      ...
      "Unsplit Screen": "Tela não dividida",
    ...
    "ru": {
      ...
      "Bold": "Жирный",
      "Italic": "Курсив",
      "Block Quote": "Блочная цитата",
      "Cut":  "Вырезать",
      "Copy":  "Копировать",
      "Paste": "Вставить",
      "Undo":  "Отменить",
      "Redo":   "Повторить",
      "Split Screen": "Разделить экран",
      "Unsplit Screen": "Не разделять экран",
    ...
    "tr": {
      ...
      "Bold": "Kalın",
      "Italic": "İtalik",
      "Block Quote": "Blok Alıntı",
      "Cut":  "Kes",
      "Copy":  "Kopyala",
      "Paste": "Yapıştır",
      "Undo":  "Geri Al",
      "Redo":   "Yeniden Yap",
      "Split Screen": "Ekranı Böl",
      "Unsplit Screen": "Ekranı Bölme",
    },
    "zh-cn": {
      "rtl": false,
      "About": "关于",
